...
use super::types::{ProviderSocialState, TreatmentAction};
...
impl PhysicianAgent {
    ...
    pub fn should_order_test(&self, obs: ClinicalObservation, p_colonized: f32) -> bool {
    ...
    pub fn receive_audit_feedback(&mut self, target: f32) {
        ...
        self.social.current_compliance = (self.social.current_compliance + boost).clamp(0.0, 1.0);
    }
}
